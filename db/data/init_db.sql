...
--
-- Host: localhost    Database: common_dev
-- ------------------------------------------------------
...
LOCK
TABLES `test_table_five` WRITE;
/*!40000 ALTER TABLE `test_table_five` DISABLE KEYS */;
INSERT INTO `test_table_five`
VALUES (1, 'null'),
	   (2, NULL),
	   (3, 'null');
...
(
	...
	`table_one_fk` int NOT NULL,
	PRIMARY KEY (`id`),
	KEY            `index2` (`table_one_fk`),
	CONSTRAINT `fk_four_one` FOREIGN KEY (`table_one_fk`) REFERENCES `test_table_one` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='description qqq';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
	`id`           int NOT NULL AUTO_INCREMENT,
	`table_one_fk` int NOT NULL COMMENT 'blabla',
	`col_text`     text,
	PRIMARY KEY (`id`),
	KEY            `index2` (`table_one_fk`),
	CONSTRAINT `fk_two_one` FOREIGN KEY (`table_one_fk`) REFERENCES `test_table_one` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='description qweqwe';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-12-10 23:18:20
